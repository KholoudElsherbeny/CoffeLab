<template>
    <div class="product_details_page">
        <div class="container mx-auto flex justify-between items-start flex-wrap gap-y-[20px]" v-for="data in myproduct" :key="data">
            <div class="image_wrapper  lg:w-[45%] w-[100%]" >
                ...
                <img :src="data.image" :alt="data.title" width="" height="" />
            </div>
            <div class="product_details_wrapper   lg:w-[55%] w-[100%]">
                ...
                <div class="flex justify-between items-center flex-wrap my-[10px]" >
                    <div class="quantity_counter_wrapper">
                        <button type="button" @click="data.quantity++"  >
                        ...
                        <button type="button" @click="data.quantity-- " :disabled="data.quantity <= 1">
                    ...
                    <div class="flex justify-between items-center  my-4 ">
                        <button class="add_to_cart" @click="data.quantity" >
